...
<body class="bg-gray-900 text-white font-sans transition-colors duration-300">
  ...
  <section class="py-16 bg-gray-900">
    <div class="max-w-7xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="100">
          <div class="text-primary text-3xl mb-4"><i class="fas fa-user-check"></i></div>
          <h3 class="text-xl font-semibold mb-2">User Authentication</h3>
          <p class="text-gray-400">Secure login, account management, and password recovery.</p>
        </div>
        <div class="bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="200">
          <div class="text-primary text-3xl mb-4"><i class="fas fa-dumbbell"></i></div>
          <h3 class="text-xl font-semibold mb-2">Flexible Workouts</h3>
          <p class="text-gray-400">Customized plans and class scheduling for every level.</p>
        </div>
        <div class="bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="300">
          <div class="text-primary text-3xl mb-4"><i class="fas fa-shopping-cart"></i></div>
          <h3 class="text-xl font-semibold mb-2">Online Store</h3>
          <p class="text-gray-400">Shop high‑quality supplements and gym gear easily.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="max-w-7xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-6 bg-gray-800 rounded-lg shadow" data-aos="fade-right">
          <p class="text-gray-400 italic">"GYM Core has completely transformed my approach to fitness. The classes keep me motivated!"</p>
        ...
        <div class="p-6 bg-gray-800 rounded-lg shadow" data-aos="fade-left">
          <p class="text-gray-400 italic">"The online store is fantastic – quality supplements and great service. I never miss a workout!"</p>
  ...
  <!-- Footer -->
  <footer class="bg-gray-900 text-gray-400 pt-16 pb-10 border-t border-gray-700 mt-16">
